...
<div class="container mt-4">
    ...
    <div class="card shadow-sm border-0">
        <div class="card-body">
            <h3 class="card-title text-center mb-4"><i class="bi bi-pencil-square me-2"></i>Edit Barang Kost</h3>
            ...
            <form method="post" onsubmit="return validateForm()">
                ...
                <div class="mb-3">
                    <label class="form-label">Harga <span class="badge bg-secondary">Rp</span></label>
